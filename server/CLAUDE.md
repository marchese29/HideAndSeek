...
curl -s -X POST localhost:8000/games/<game_id>/found \
  -H "X-Player-Id: $SEEKER_PLAYER_ID" -H "X-Player-Secret: $SEEKER_SECRET"
# → 204. Emits FoundClaimEvent to hider SSE; push to hiders.
